...
class TestExcel(unittest.TestCase):
    ...
    def test_UKGK_1(self):
        ...
        df = pd.read_excel('QA/Output Files/OUTPUT UKGKronos/UKG Kronos empty.xlsx', header=None)
    ...
    def test_UKGK_2(self):
        ...
        #File: Hannibal
            ...
            # Upload Excel file
            excel_file = 'QA/Output Files/OUTPUT UKGKronos/Qualivis Time report PPE 062423.xlsx'
    ...
    def test_UKGK_5(self):
        path_file = 'QA/Output Files/OUTPUT UKGKronos/Qualivis Time report PPE 062423.xlsx'
        sheet_namee = 'Sheet1'
        column = 'PRIMARY JOB'
    ...
    def test_UKGK_7(self):
        pahtfile = 'QA/Output Files/OUTPUT UKGKronos/Qualivis Time report PPE 062423.xlsx'
    ...
    def test_UKGK_8(self):
        ...
        df = pd.read_excel("QA/Output Files/OUTPUT UKGKronos/Qualivis Time report PPE 062423.xlsx")
    ...
    def test_UKGK10(self):
        ...
        # Load the Excel file into a pandas DataFrame
        file_path = "QA/Output Files/OUTPUT UKGKronos/Qualivis Time report PPE 062423.xlsx"
        sheet_name = "Sheet1"
