...
class ExcelTestCase(unittest.TestCase):
    ...
    def test_DEFAULT_1(self):
        ...
        df = pd.read_excel('QA/Output Files/OUTPUT Default/Default Empty.xlsx', header=None)
    ...
    # Excel files you wish to validate along with their names
        filenames = [
            ("QA/Output Files/OUTPUT Default/time weston minutes.xlsx", "time weston.xlsx"),
            ("QA/Output Files/OUTPUT Default/time weston minutes.xlsx", "time weston minutes.xlsx")
        ]
    ...
    # Excel files you wish to validate along with their names
        filenames = [
            ("QA/Output Files/OUTPUT Default/1667243700213_980358248.xlsx", "1667243700213_980358248.xlsx"),
            ("QA/Output Files/OUTPUT Default/1667243700213_980358248 minutes.xlsx", "1667243700213_980358248 minutes.xlsx")
        ]
    ...
    def test_DEFAULT_6(self):
        files = ["QA/Output Files/OUTPUT Default/Kronos Timecards TC 07-30-22.xlsx", 
                 "QA/Output Files/OUTPUT Default/Kronos Timecards TC 07-30-22 minutes.xlsx"]
    ...
    def test_DEFAULT_7(self):
        file1 = "QA/Output Files/OUTPUT Default/Pages 26-40 from Time Detail_July152022 minutes.xlsx"
        file2 = "QA/Output Files/OUTPUT Default/Pages 26-40 from Time Detail_July152022.xlsx"
    ...
    def test_DEFAULT_10(self):
        ...
        file_data = [
            {'file_path': 'QA/Output Files/OUTPUT Default/Pages 1-116 from Scripps Approved Kronos we 6.25.22 minutes.xlsx', 'sheet_name': 'Sheet1'},
            {'file_path': 'QA/Output Files/OUTPUT Default/Pages 117-223 from Scripps Approved Kronos we 6.25.22 minutes.xlsx', 'sheet_name': 'Sheet1'},
            {'file_path': 'QA/Output Files/OUTPUT Default/Pages 1-116 from Scripps Approved Kronos we 6.25.22.xlsx', 'sheet_name': 'Sheet1'},
            {'file_path': 'QA/Output Files/OUTPUT Default/Pages 117-223 from Scripps Approved Kronos we 6.25.22.xlsx', 'sheet_name': 'Sheet1'}
        ...
        if all_error_messages:
            ...
            if correct_files:
                print(f"TEST 10 DEFAULT CORRECT: Column Date format is correct in all files Scripps Approved Kronos we 6.25.22")

    def test_default_11(self): 
        # Files to validate
        #Desc: Date with Dash needs to be display
        file_paths = ['QA/Output Files/OUTPUT Default/Pages 1-116 from Scripps Approved Kronos we 6.25.22 minutes.xlsx',
                      "QA/Output Files/OUTPUT Default/Pages 117-223 from Scripps Approved Kronos we 6.25.22 minutes.xlsx",
                      'QA/Output Files/OUTPUT Default/Pages 1-116 from Scripps Approved Kronos we 6.25.22.xlsx',
                      "QA/Output Files/OUTPUT Default/Pages 117-223 from Scripps Approved Kronos we 6.25.22.xlsx"]
        sheet_name = 'Sheet1'
    ...
    def test_DEFAULT_12(self):
        ...
        # List of file paths and sheet names to validate
        file_data = [
            {'file_path': 'QA/Output Files/OUTPUT Default/Pages 1-24 from Time Detail_100822-102122 minutes.xlsx', 'sheet_name': 'Sheet1'},
            {'file_path': 'QA/Output Files/OUTPUT Default/Pages 1-24 from Time Detail_100822-102122.xlsx', 'sheet_name': 'Sheet1'}
        ]
    ...
    def test_DEFAULT_19_1_1(self):
        file_paths = [
            "QA/Output Files/OUTPUT Default/Pages 1-164 from 1690808400472_1671940182.xlsx",
            "QA/Output Files/OUTPUT Default/Pages 1-164 from 1690808400472_1671940182 minutes.xlsx"
        ]
        
        expected_glcode_count = 47
        all_errors = []
        ...
        if all_errors:
            ...
            print("TEST 19_1_1 DEFAULT CORRECT: The files have only the expected number of GLCODE cells.")   

    def test_DEFAULT_19_1_2(self):
        file_paths = [
            "QA/Output Files/OUTPUT Default/Pages 165-329 from 1690808400472_1671940182 minutes.xlsx",
            "QA/Output Files/OUTPUT Default/Pages 165-329 from 1690808400472_1671940182.xlsx"
        ]
        
        expected_glcode_count = 65
        all_errors = []
        ...
        if all_errors:
            ...
            print("TEST 19_1-2 DEFAULT CORRECT: The files have only the expected number of GLCODE cells.") 
    ...
    def test_DEFAULT_19_2_1(self):
        ...
        if all_errors:
            ...
            print("TEST 19_2_1 DEFAULT CORRECT: The files have only the expected number of GLCODE cells.")
